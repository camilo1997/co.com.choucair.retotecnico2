...
Feature: Como usuario desero ingresar mi informacion basica para
  ...
  Scenario Outline: intento de registro de usuario exitoso
    ...
    Examples:
      ...
      |Carlos|Soto|carlos7ms778@mailirftnator.com|October|15|1988|Spanish|Linux|Ubuntu|English|Apple|iPhone|iOS 14.4|A123789456a|A123789456a|Welcome to the world's largest community of freelance software testers!|